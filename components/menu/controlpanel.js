      ...
      <View style={styles.control_main}> 
        ...
        <View style={{flex:7/10,flexDirection:"column"}}>
          <View style={{flex:1.5/10,flexDirection:"row",borderBottomWidth:0.4,borderBottomColor:'#f5f5f5',padding:5}}>
            <TouchableOpacity onPress={()=>{ dispatch({type:'BOOKING_HISORY'})}} style={{flex:1,justifyContent:'center',alignItems:'flex-start'}}>
              <Text style={{color:'#f5f5f5'}}>Tổng chi tiêu 2018</Text>
              <Text style={{color:'#fff',fontSize:20,fontWeight:'bold'}}>120.000 đ</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={()=>{ dispatch({type:'LOGIN'}) }} style={{flex:1,justifyContent:'center',alignItems:'flex-end'}}>
          ...
          <View style={{flex:1/10,flexDirection:"row",borderBottomWidth:0.4,borderBottomColor:'#f5f5f5'}}>
            <TouchableOpacity onPress={()=>{ dispatch({type:'LOGIN'}) }} style={{flex:1,justifyContent:'center',alignItems:'center',padding:2}}>
          ...
          <View style={{flex:3/10,flexDirection:"column",borderBottomWidth:0.4,borderBottomColor:'#f5f5f5'}}>
            <View style={{flex:1,flexDirection:"row"}}>
              <TouchableOpacity onPress={()=>{ dispatch({type:'HOME'}) }} style={{flex:1,flexDirection:'column',justifyContent:'center',alignItems:'center',padding:2}}>
                <Icon name="ios-home-outline" size={25} color="#fff" />
                <Text style={{color:'#fff',fontSize:11}}>Trang Chủ</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={()=>{ dispatch({type:'LOGIN'})}} style={{flex:1,flexDirection:'column',justifyContent:'center',alignItems:'center',padding:2}}>
                <Icon name="ios-contact-outline" size={25} color="#fff" />
                <Text style={{color:'#fff',fontSize:11}}>Thành Viên</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={()=>{ dispatch({type:'BOOKING_HISORY'}) }} style={{flex:1,flexDirection:'column',justifyContent:'center',alignItems:'center',padding:2}}>
            ...
            <View style={{flex:1,flexDirection:"row"}}>
              ...
              <TouchableOpacity onPress={()=>{ dispatch({type:'NOTIFICATION'}) }} style={{flex:1,flexDirection:'column',justifyContent:'center',alignItems:'center',padding:2}}>
